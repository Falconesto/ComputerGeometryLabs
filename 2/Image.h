...
public:
    ...
    void draw45Line(std::vector<Point> points, int color, double brightness, int bad);

    bool isInsideXtoTheLeft(Point first, Point second, double checkX, double checkY);

    bool isInsideXtoTheRight(Point first, Point second, double checkX, double checkY);

    bool isInsideYtoTheUp(Point first, Point second, double checkX, double checkY);

    bool isInsideYtoTheDown(Point first, Point second, double checkX, double checkY);

    bool isInside(std::vector<Point> points, double checkX, double checkY);
